...
var mailer = {
	...
	to:'wilfredf@hexaware.com,saisub@hexaware.com,omprakashr@hexaware.com,rahulp@hexaware.com,rahulp2@hexaware.com,ravindrag@hexaware.com,ravindra.gharpure@gmail.com,arjunb@hexaware.com,arjunbhexaware@gmail.com',
...
mailPackageDetails:function(reqBody){
	return new Promise(function(resolve, reject){
		...
		readModuleFile('./packageDetails.html').then((words)=> {
			//console.log(words);
			mailContent =words;			
			var mailOptions = {
			from: 'hexatestmailer@gmail.com',
			//  to: 'arjunbhexaware@gmail.com,arjunb@hexaware.com,harikrishnanv@hexaware.com',
             to:'wilfredf@hexaware.com,saisub@hexaware.com,omprakashr@hexaware.com,rahulp@hexaware.com,rahulp2@hexaware.com,ravindrag@hexaware.com,ravindra.gharpure@gmail.com,arjunb@hexaware.com,arjunbhexaware@gmail.com',
